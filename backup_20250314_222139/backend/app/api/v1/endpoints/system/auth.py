...
from backend.app.schemas.user import UserCreate, UserOut, Token, UserLogin, UserCreateManager, UserCreateAdmin
from backend.app.core.security import verify_password, get_password_hash, create_access_token
from backend.app.api.v1.dependencies import get_current_user, get_current_admin
...
def register_user(user: UserCreate, db: Session = Depends(get_db)):
    ...
    # 演员角色自动创建关联的演员资料
    if user.role == "performer":
        from backend.app.models.actor import Actor, ActorProfessionalInfo, ActorContactInfo
        import uuid
        import datetime
